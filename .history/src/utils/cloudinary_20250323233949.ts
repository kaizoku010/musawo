...
export const uploadToCloudinary = async (file: File): Promise<string> => {
  ...
  Log in to your Cloudinary dashboard and check the media library to see if the images are being uploaded correctly. This can give you more insight into what might be going wrong.